...
<xsl:stylesheet xmlns:cac="urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2"
   ...
   <xsl:template match="cac:ClassifiedTaxCategory/cbc:ID" priority="1000" mode="M16">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="(( not(contains(normalize-space(.),' ')) and contains( ' SR SRCA-S SRCA-C SRRC SROVR-RS SROVR-LVG SRLVG ZR ES33 ESN33 DS OS NG NA TX TXCA TXNA ZP IM ME IGDS BL NR EP OP TXR-TS TX-ESS TXRC-ESS IM-ESS TX-N33 TXRC-N33 IM-N33 TX-RE TXRC-RE IM-RE ',concat(' ',normalize-space(.),' ') ) ) )">
